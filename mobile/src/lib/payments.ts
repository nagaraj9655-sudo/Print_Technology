// Payment reminders + UPI helpers (WhatsApp / SMS / UPI QR). Verbatim from web app.
// URLSearchParams is provided by react-native-url-polyfill (imported in supabase.ts).
