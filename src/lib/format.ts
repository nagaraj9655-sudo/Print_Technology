// Formatting helpers — Indian rupee grouping, amount-in-words, dates.
...
// Excel serial (base 1899-12-30) => ISO date. Used by the migration importer.
export function excelSerialToISO(serial: number): string {
  const ms = Math.round((serial - 25569) * 86400 * 1000)
  return new Date(ms).toISOString().slice(0, 10)
}

// Indian Financial Year label from a date, e.g. 2025-06-10 => "2025-26" (FY starts April).
